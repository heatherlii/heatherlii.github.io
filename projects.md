	...
	<section>
		...
		<div class="content">
			<div class="inner">
				...
				<p>For the laser engraved pieces, I used Adobe Illustrator and SolveSpace to create the designs. TALK MORE IN DEPTH ABOUT THE PROCESS. MENTION THAT THEY WERE FOR DIFFERENT SCHOOL PROJECTS??? (HIGH SCHOOL & UNI)
				<ul class="actions">
					<li><a href="projects.html" class="button">Learn more</a></li>
				</ul>
			</div>
